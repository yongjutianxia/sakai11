// This class is taken almost verbatim from opensaml 2.5.1, and modified to skip
// the Velocity init step (which conflicts with the version of velocity that
// ships with CLE)
 ...
 */
public class NoVelocitySamlBootstrap {
    ...
    /** Constructor. */
    protected NoVelocitySamlBootstrap() {
    ...
    protected static Logger getLogger() {
        return LoggerFactory.getLogger(NoVelocitySamlBootstrap.class);
    }
}
