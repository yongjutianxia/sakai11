...
if [ -e "$tomcat/shared/lib/sakai-import-bb6-10.1.jar" ]; then
    echo "Moving blackboard jar into components/import-pack/WEB-INF/lib"
    mv "$tomcat/shared/lib/sakai-import-bb6-10.1.jar" "$tomcat/components/import-pack/WEB-INF/lib"
fi

if [ -e "$tomcat/shared/lib/sakai-import-bb9-nyu-10.1.jar" ]; then
    echo "Moving blackboard 9 jar into components/import-pack/WEB-INF/lib"
    mv "$tomcat/shared/lib/sakai-import-bb9-nyu-10.1.jar" "$tomcat/components/import-pack/WEB-INF/lib"
fi



echo "Installing Samigo jar to import-pack component directory"
cp "$build_dir/samigo/samigo-archive/sam-handlers/target/samigo-import-10.1.jar" \
    "$tomcat/components/import-pack/WEB-INF/lib/"

echo "Moving sakai-anouncement-import [sic] jar"
mv "$tomcat/components/sakai-anouncement-import/WEB-INF/lib/sakai-import-announcement-10.1.jar" \
    "$tomcat/components/import-pack/WEB-INF/lib/"
