create table scs_scorm_job (uuid varchar2(36) primary key, siteid varchar2(36), externalid varchar2(255), resourceid varchar2(255), title varchar2(255), graded int, ctime number, mtime number, retry_count int default 0, status varchar2(32), deleted int default 0, error_message varchar(1024));
