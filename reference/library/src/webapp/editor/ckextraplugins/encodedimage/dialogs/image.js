					...
					[
						{
							...
							[
								...
								{
									type: 'html',
									html: editor.lang.encodedimage.encodelabel 
								},
								/*
								{
									...
									align : 'center',
									label : editor.lang.encodedimage.browseExisting,
									hidden : true,
									filebrowser :
									{
										action : 'Browse',
										...
										onSelect: function (fileUrl, errorMessage) {
											if (fileUrl) {
												setBase64ToImageUrl(fileUrl,this.getDialog(),'info','txtUrl');
											}
										},
								...
								*/
								{
									...
									style : 'display:inline-block;margin-top:10px;',
									align : 'center',
									label : editor.lang.encodedimage.browseComputer,
									hidden : true,
									filebrowser :
									{
										action : 'Browse',
										...
										//This URL needs to be modified to point to my Computer
										url: editor.config.filebrowserImagePrivate
