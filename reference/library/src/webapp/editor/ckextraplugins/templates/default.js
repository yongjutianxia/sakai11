...
*/
CKEDITOR.addTemplates('customtemplates', {imagesPath: CKEDITOR.getUrl(CKEDITOR.basePath.substr(0, CKEDITOR.basePath.indexOf("nyu-ckeditor/"))+"ckextraplugins/" + 'templates/images/'), templates: [
    {
