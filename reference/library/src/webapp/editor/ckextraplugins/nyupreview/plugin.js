 ...
 * NYU's Sakai instance.  It adds all the page CSS to the preview HTML and also
...
( function() {
	...
	var pluginName = 'nyupreview';

	// Register a plugin named "nyupreview".
	CKEDITOR.plugins.add( pluginName, {
		...
		init: function( editor ) {
			...
			editor.ui.addButton && editor.ui.addButton( 'NYUPreview', {
