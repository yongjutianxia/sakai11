...
CKEDITOR.plugins.setLang('autosave', 'en', {
    ...
    loadSavedContent: 'An auto-saved version of this content from "{0}" has been found. Would you like to load it now? Clicking Cancel will remove previously auto-saved content.',
