...
public class ContentPackage implements Serializable {
	...
	public static final Integer STORE_MOST_RECENT_GRADE = 0;
	public static final Integer STORE_HIGHEST_GRADE = 1;
	private Integer storeGradeOption = STORE_MOST_RECENT_GRADE;

	public Integer getStoreGradeOption() {
		if(storeGradeOption == null){
			storeGradeOption = STORE_MOST_RECENT_GRADE;
		}
		return storeGradeOption;
	}

	public void setStoreGradeOption(Integer storeGradeOption) {
		this.storeGradeOption = storeGradeOption;
	}
