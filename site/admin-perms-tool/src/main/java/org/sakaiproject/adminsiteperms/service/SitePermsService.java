                ...
                try {
                    ...
                    if (authzGroupService.allowUpdate(ag.getId())) {
                        ...
                        if (updated) {
                            ...
                            updatesCount++;
                            log.info("Added Permissions ("+permsString+") for roles ("+rolesString+") to group:" + realm);
                        }
                        successCount++;
                        ...
                        log.warn("Cannot update authz group: " + realm + ", unable to apply any perms change");
                    }
                } catch (GroupNotDefinedException e) {
                    log.error("Could not find authz group: " + realm + ", unable to apply any perms change");
                } catch (AuthzPermissionException e) {
                    log.error("Could not save authz group: " + realm + ", unable to apply any perms change");
                }
                sitesCounter++;
                if (!isLockedForUpdates()) {
