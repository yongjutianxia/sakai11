/* *****************************************************************************
 * Bb9NYUAnnouncementTranslator.java - created by aaronz
 * 
 ...
 */
public class Bb9NYUAnnouncementTranslator implements IMSResourceTranslator {

	private static Log log = LogFactory.getLog(Bb9NYUAnnouncementTranslator.class);
	...
	public Importable translate(Node resourceNode, Document descriptor, String contextPath, String archiveBasePath) {
		...
		item.setLegacyGroup(Blackboard9NYUFileParser.ANNOUNCEMENT_GROUP);
		return item;
	}
